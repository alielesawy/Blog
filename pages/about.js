...
import { FaLaptop, FaLinkedinIn } from "react-icons/fa";
    ...
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        <p className="text-gray-600 mt-4 dark:text-indigo-200">
          I am a self taught developer currently enhancing my skills at Backend Development by Java . My field of Interest's are building new Web
          Technologies  and also in areas related to Cloud Computing.
